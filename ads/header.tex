...
\documentclass[%
	...
	topmargin = 10pt,	% Abstand Seitenrand (Std:1in) zu Kopfzeile
	headheight = 12pt,	% Höhe der Kopfzeile
	headsep = 30pt,	% Abstand zwischen Kopfzeile und Text Body
...
\usepackage[margin=3cm,foot=2cm]{geometry}	% Seitenränder und Abstände
