...
\iflang{de}{\usepackage[english, ngerman]{babel}} % Paket babel benutzt neue deutsche Rechtschreibung
\iflang{en}{\usepackage[english]{babel}} % Paket babel benutzt Englisch
